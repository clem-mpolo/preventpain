...
<body class="bg-sky-50">
    <header class="bg-gradient-to-r from-sky-600/80 to-blue-600/80 backdrop-blur-sm text-white fixed w-full z-50">
    ...
    <main>
        <section id="accueil" class="relative -mt-24 pt-0 pb-12 bg-gradient-to-r from-sky-400 to-blue-500 text-white overflow-hidden">
            <div class="absolute inset-0 z-0">
                <div class="absolute inset-0 bg-gradient-to-r from-sky-400/90 to-blue-500/90"></div>
            </div>
            <div class="container mx-auto px-6 py-32 relative z-10">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative hidden md:block">
                        ...
                        <div class="relative">
                            <img src="{{asset('assets/img/ajcas.png')}}" alt="Exemple de site web" class="rounded-2xl shadow-2xl transform rotate-2 hover:rotate-0 transition duration-500">
